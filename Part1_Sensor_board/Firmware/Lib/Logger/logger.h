#ifndef __PLANT_SENS_LOGGER_H__
#define __PLANT_SENS_LOGGER_H__
...
// If no debug level is defined, default to INFO
	...
	!defined(MIN_LOG_LEVEL_DEBUG) && !defined(MIN_LOG_LEVEL_INFO) && \
	!defined(MIN_LOG_LEVEL_WARN) && !defined(MIN_LOG_LEVEL_ERROR) && \
	!defined(MIN_LOG_LEVEL_FATAL) && !defined(MIN_LOG_LEVEL_OFF)
